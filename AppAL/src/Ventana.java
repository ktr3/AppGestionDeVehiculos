...
//				 VALUES ('1030FDD', '56783RT', 'Gris', '4', '7890', '1', '2', '50');
		...
		btnNewButton_1_1.setBounds(277, 317, 184, 23);
		...
		btnNewButton_1.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Conexion con = new Conexion();
				con.conectar();
				con.agregar("INSERT INTO camiones (matricula, numBastidor, color,"
						+ " numAsientos, precio, id_serie, carga, tipoMercancia) values "
						+ "('"+textField_8.getText()+"', '"+textField_12.getText()+"', "
						+ "'"+textField_13.getText()+"','"+textField_14.getText()+"',  "
						+ "'"+textField_21.getText()+"', '"+textField_15.getText()+"'"
		...
		btnNewButton_1_1_1.setBounds(277, 317, 184, 23);
